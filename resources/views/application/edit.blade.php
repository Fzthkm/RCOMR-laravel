...
@section('content')
    ...
    <form action="{{ route('application.update', $application->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="number" id="number" value="{{$application->number}}" class="form-control">
        </div>
        <div class="form-group mb-3">
            ...
            <input type="date" name="creating_date" id="creating_date" class="form-control"
                   value="{{$application->creating_date}}">
        </div>
        <div class="form-group mb-3">
            ...
            <input type="date" name="consult_date" id="consult_date" class="form-control"
                   value="{{$application->consult_date}}">
        </div>
        <!-- Организация -->
        <div class="form-group mb-3">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" name="patient_name" id="patient_name" class="form-control"
                   value="{{$application->patient_name}}">
        </div>
        <div class="form-group mb-3">
            ...
            <input type="number" name="patient_year" id="patient_year" class="form-control"
                   value="{{$application->patient_year}}">
        </div>
        <div class="form-group mb-3">
            <label for="diagnosis" class="form-label">Диагноз</label>
            <input type="text" name="diagnosis" id="diagnosis" class="form-control" value="{{$application->diagnosis}}">
        </div>
        <div class="form-group mb-3">
